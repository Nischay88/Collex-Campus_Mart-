...
const AddProduct = () => {
  ...
  const handleImageChange = (e) => {
    ...
    if (files.length < 2) {
      setErrors(prev => ({ ...prev, images: 'Please upload at least 2 images' }));
      return;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // const response = await fetch('http://localhost:8080/api/seller/add', {
      //   method: 'POST',
      //   headers: {
      ...
      <div className="form-container">
        ...
        <form className="product-form" onSubmit={handleSubmit}>
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              <label htmlFor="images" className="form-label">Upload Images (2-5 images) *</label>
              <input
                type="file"
                id="images"
                name="images"
              ...
              <span className="helper-text">Upload 2 to 5 product images</span>
            </div>
