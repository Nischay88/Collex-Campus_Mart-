...
const BuyerLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // const response = await fetch('http://localhost:8080/api/auth/buyer/login', {
      //   method: 'POST',
      ...
      if (mockResponse.success) {
        ...
        localStorage.setItem('buyerToken', mockResponse.user.token);
    ...
    <div className="buyer-login-page">
      <div className="login-container">
        <div className="login-header">
          ...
          <p className="login-subtitle">Welcome back! Sign in to continue shopping</p>
        </div>
        ...
        <div className="login-footer">
          <p className="footer-text">
            ...
            <Link to="/signup/buyer" className="footer-link">
              Sign Up
            </Link>
          </p>
